...
const Login = () => {
  ...
  const { setuser, navigate, settoken } = useContext(appContext);
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                Welcome<span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400"> Back</span>
              </h1>
              ...
              >
                ...
                <form onSubmit={submitHandler} className="space-y-5">
                  ...
                  <div className="flex items-start gap-3 mt-4">
                    ...
                    />
                    <label htmlFor="acceptTermsLogin" className="text-gray-300 text-sm cursor-pointer">
                      I agree to the{" "}
                ...
                <div className="text-center mt-6 pt-6 border-t border-gray-700/30">
                  <p className="text-gray-400 text-sm">
                    ...
                    <Link to="/signup" className="text-white hover:text-gray-300 font-medium transition-colors duration-300">
                      Create Account
                    </Link>
                  </p>
                </div>
