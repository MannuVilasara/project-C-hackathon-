          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-6 border border-white/10">
                ...
                <ul className="space-y-2 text-gray-400">
                  <li>• <span className="text-cyan-400">React.js</span> with modern hooks</li>
                  ...
                  <li>• <span className="text-orange-400">React Router</span> for navigation</li>
                  <li>• <span className="text-purple-400">Context API</span> for state management</li>
                </ul>
              </div>
            </div>
          </div>
