...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/user/send-message`, {
        name: formData.name,
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 rounded-xl bg-black/40 text-white border border-gray-600/40 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 transition-all duration-300"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-3 rounded-xl bg-black/40 text-white placeholder-gray-400 border border-gray-600/40 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 transition-all duration-300 resize-none"
